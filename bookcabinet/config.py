...
# ВНИМАНИЕ: Реальное подключение отличается от документации!
# =============================================================================
GPIO_PINS = {
    ...
    # Сервоприводы замков — РЕАЛЬНОЕ подключение (найдено сканированием!)
    'SERVO_LOCK_1': 12,     # Передний замок (было 18 в документации)
...
# RFID - Считыватели
# =============================================================================
# Внешняя панель: два считывателя для карт пользователей
...
RFID = {
    ...
    'card_debounce_ms': 800,              # Защита от дребезга (мс)
